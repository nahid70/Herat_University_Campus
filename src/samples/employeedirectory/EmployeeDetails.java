...
public class EmployeeDetails extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.rawQuery("SELECT emp._id, emp.buildingName, emp.buildingDetails, mgr.buildingName managerFirstName, mgr.buildingDetails managerLastName FROM universityName emp LEFT OUTER JOIN universityName mgr ON emp.managerId = mgr._id WHERE emp._id = ?", 
        ...
        if (cursor.getCount() == 1)
        {
	        ...
	        employeeName.setText(cursor.getString(cursor.getColumnIndex("buildingName")));
	
	        employeeTitle = (TextView) findViewById(R.id.title);
	        employeeTitle.setText(cursor.getString(cursor.getColumnIndex("buildingDetails")));
